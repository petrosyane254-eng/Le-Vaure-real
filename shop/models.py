...
class PageSection(models.Model):
    ...
    desktop_height = models.PositiveIntegerField(
        default=620,
        help_text="Banner height on desktop (px)"
    )
    mobile_height = models.PositiveIntegerField(
        default=420,
        help_text="Banner height on mobile (px)"
    )

    image_x = models.PositiveSmallIntegerField(
        default=50,
        help_text="Image horizontal position: 0-100"
    )
    image_y = models.PositiveSmallIntegerField(
        default=50,
        help_text="Image vertical position: 0-100"
    )
    image_zoom = models.DecimalField(
        max_digits=4,
        decimal_places=2,
        default=1.00,
        help_text="Image zoom: 1.00-3.00"
    )

    overlay_opacity = models.PositiveSmallIntegerField(
        default=35,
        help_text="Overlay opacity: 0-100"
    )

    content_x = models.PositiveSmallIntegerField(
        default=8,
        help_text="Text horizontal position: 0-100"
    )
    content_y = models.PositiveSmallIntegerField(
        default=72,
        help_text="Text vertical position: 0-100"
    )
    content_width = models.PositiveSmallIntegerField(
        default=45,
        help_text="Text block width: 20-100%"
    )

    title_size = models.PositiveIntegerField(
        default=48,
        help_text="Desktop title size (px)"
    )
    mobile_title_size = models.PositiveIntegerField(
        default=34,
        help_text="Mobile title size (px)"
    )
    body_size = models.PositiveIntegerField(
        default=13,
        help_text="Body text size (px)"
    )
...
# =========================================================
# DESIGN STUDIO — PERSISTENT DRAFT / PUBLISHED DESIGN
# =========================================================
...
class SiteDesign(models.Model):
    ...
    def __str__(self):
        return f"LE VAURÉ Design / {self.key}"
