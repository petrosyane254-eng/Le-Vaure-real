...
class SiteSettings(models.Model):
    ...
    footer_shop_title = models.CharField(max_length=80, default="SHOP")
    footer_help_title = models.CharField(max_length=80, default="HELP")
    footer_company_title = models.CharField(max_length=80, default="COMPANY")
    footer_payment_title = models.CharField(max_length=80, default="WE ACCEPT")
    footer_payment_labels = models.CharField(max_length=240, default="VISA,MC,Idram,Telcell", help_text="Comma-separated labels")
    footer_copyright_text = models.CharField(max_length=220, blank=True, default="LE VAURÉ. All rights reserved.")
    product_card_image_ratio = models.CharField(max_length=20, default="4 / 5", help_text="CSS aspect-ratio, e.g. 4 / 5 or 1 / 1")
    product_card_radius = models.PositiveIntegerField(default=0, help_text="Product image/card corner radius in pixels")
    product_grid_gap = models.PositiveIntegerField(default=24, help_text="Gap between product cards in pixels")
...
class HomeHeroSlide(models.Model):
    ...
    image = models.ImageField(
        upload_to="home/heroes/",
        blank=True,
        null=True,
    )
    mobile_image = models.ImageField(
        upload_to="home/heroes/mobile/",
        blank=True,
        null=True,
    )
    video = models.FileField(
        upload_to="home/heroes/videos/",
        blank=True,
        null=True,
    )
    mobile_video = models.FileField(
        upload_to="home/heroes/videos/mobile/",
        blank=True,
        null=True,
    )
    video_poster = models.ImageField(
        upload_to="home/heroes/posters/",
        blank=True,
        null=True,
    )
...
class ShopPageSettings(models.Model):
    title = models.CharField(max_length=160, default="SHOP T-SHIRTS")
    eyebrow = models.CharField(max_length=100, blank=True, default="SHOP")
    subtitle = models.CharField(max_length=260, blank=True, default="Premium pieces inspired by Armenia, people and places.")
    breadcrumb_home_label = models.CharField(max_length=60, default="Home")
    search_placeholder = models.CharField(max_length=120, default="Search products...")
    category_heading = models.CharField(max_length=80, default="CATEGORY")
    size_heading = models.CharField(max_length=80, default="SIZE")
    color_heading = models.CharField(max_length=80, default="COLOR")
    price_heading = models.CharField(max_length=80, default="PRICE")
    clear_filters_label = models.CharField(max_length=80, default="CLEAR FILTERS")
    all_products_label = models.CharField(max_length=80, default="All Products")
    empty_text = models.CharField(max_length=160, default="No products found.")
    loading_text = models.CharField(max_length=160, default="Loading collection…")
    ...
    hero_background_color = models.CharField(max_length=7, default="#F5F5F2")
    hero_text_color = models.CharField(max_length=7, default="#111111")
    sidebar_background_color = models.CharField(max_length=7, default="#FFFFFF")
    card_background_color = models.CharField(max_length=7, default="#FFFFFF")
    updated_at = models.DateTimeField(auto_now=True)

    class Meta:
        verbose_name = "Shop page settings"
        verbose_name_plural = "Shop page settings"
...
class PageSection(models.Model):
    ...
    key = models.SlugField(max_length=80, help_text="Stable section key, e.g. hero, story, values, support")
    eyebrow = models.CharField(max_length=100, blank=True, default="")
    title = models.CharField(max_length=180, blank=True, default="")
    body = models.TextField(blank=True, default="")
    ...
    button_background_color = models.CharField(max_length=7, default="#111111")
    button_text_color = models.CharField(max_length=7, default="#FFFFFF")
    layout = models.CharField(max_length=20, choices=LAYOUT_CHOICES, default="text")
    image_position = models.CharField(max_length=40, default="center center")
    min_height = models.PositiveIntegerField(default=0, help_text="0 = automatic height")
    desktop_height = models.PositiveIntegerField(default=620, help_text="Banner height on desktop (px)")
    mobile_height = models.PositiveIntegerField(default=420, help_text="Banner height on mobile (px)")
    image_x = models.PositiveSmallIntegerField(default=50, help_text="Image horizontal focal point: 0-100")
    image_y = models.PositiveSmallIntegerField(default=50, help_text="Image vertical focal point: 0-100")
    image_zoom = models.DecimalField(max_digits=4, decimal_places=2, default=1.00, help_text="Image zoom, e.g. 1.00–3.00")
    overlay_opacity = models.PositiveSmallIntegerField(default=35, help_text="Dark overlay: 0-100")
    content_x = models.PositiveSmallIntegerField(default=8, help_text="Text horizontal position: 0-100")
    content_y = models.PositiveSmallIntegerField(default=72, help_text="Text vertical position: 0-100")
    content_width = models.PositiveSmallIntegerField(default=45, help_text="Text block width: 20-100%")
    title_size = models.PositiveIntegerField(default=48, help_text="Desktop title size (px)")
    mobile_title_size = models.PositiveIntegerField(default=34, help_text="Mobile title size (px)")
    body_size = models.PositiveIntegerField(default=13, help_text="Body text size (px)")
