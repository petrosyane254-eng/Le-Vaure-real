...
# levaurÃ©.store is an internationalized domain name (IDN).
...
GOOGLE_CLOUD_CREDENTIALS_JSON = os.getenv(
...
if GS_BUCKET_NAME:
    ...
    try:
        ...
        raise RuntimeError(
            "Google Cloud Storage is enabled, but "
...
RESEND_FROM_EMAIL = os.getenv(
    "RESEND_FROM_EMAIL",
    "LE VAURÃ‰ <onboarding@resend.dev>",
).strip()
...
UNFOLD = {
    "SITE_TITLE": "LE VAURÃ‰ Admin",

    "SITE_HEADER": "LE VAURÃ‰ ADMIN",
