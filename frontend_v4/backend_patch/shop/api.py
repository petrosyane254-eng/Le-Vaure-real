...
from .models import (
    ...
    NavigationItem, HomeHeroSlide, PromoBanner, EditorialBlock, StorefrontSection, StoreBenefit, JournalPost,
...
def register(request):
    ...
    send_mail("Your LE VAURÉ verification code", f"Your verification code is {code}. It expires in 15 minutes.", None, [email], fail_silently=False)
...
def verify_email(request):
    ...
    user_id = data.get("userId") or request.session.get("verify_user_id")
